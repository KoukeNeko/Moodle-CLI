...
echo "==> 2/6 動態建立並匯出 runtime-role fixture"
"$REPO_DIR/test/e2e/role-fixture.sh" "$VERSION"

echo "==> 3/6 逐一驗證 runtime principal 的 typed WS transport"
"$REPO_DIR/test/e2e/role-preflight.sh" "$VERSION"

echo "==> 4/6 由 Moodle 資料庫核對 fixture 真值"
